    ...
    return (
        <div className="w-screen h-[27em] flex flex-col p-10 items-center justify-around md:flex-row" id="recomendations">
            <div className="flex flex-col items-center space-y-12">
                ...
                <button type="button" className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-khtextPurple to-khsecondaryPurple hover:text-white" onClick={() => openPdf('/recommendations/worthington.pdf')}>
